...
export default function AuthorDetailPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 space-y-8">
      ...
      <div className="p-8 rounded-3xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-md flex flex-col md:flex-row gap-6 items-center md:items-start">
        <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-amber-700 to-amber-500 text-white flex items-center justify-center font-serif font-bold text-4xl shadow-xl flex-shrink-0">
        ...
        <div className="space-y-3 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-4 text-xs font-semibold text-amber-800 dark:text-amber-300">
            {author.birthYear && <span>🗓️ Năm sinh: {author.birthYear}</span>}
