  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-serif font-bold text-amber-400">📩 Quản Lý Góp Ý & Phản Hồi</h1>
          <p className="text-slate-400 text-sm">Duyệt (APPROVED) hoặc Từ chối (REJECTED) góp ý của độc giả</p>
        </div>
        ...
        <div className="flex items-center gap-2 bg-slate-900 p-1.5 rounded-xl border border-slate-800">
          <button
            ...
            className={`px-3 py-1 rounded-lg text-xs font-bold transition ${
              statusFilter === '' ? 'bg-amber-600 text-white' : 'text-slate-400 hover:text-white'
            }`}
          >
            Tất cả
          </button>
                    ...
                    <td className="px-6 py-4 text-right space-x-2">
                      {!isResolved && (
                        <button
                          ...
                          className="px-3 py-1 bg-emerald-600/30 hover:bg-emerald-600 text-emerald-200 rounded-lg text-xs font-bold transition"
                        >
                          ✓ Duyệt
                        </button>
                      )}
                      {!isRejected && (
                        <button
                          ...
                          className="px-3 py-1 bg-rose-600/30 hover:bg-rose-600 text-rose-200 rounded-lg text-xs font-bold transition"
                        >
                          ✕ Từ Chối
                        </button>
                      )}
