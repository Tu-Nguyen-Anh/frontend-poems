      ...
      {totalPages > 1 && (
        <div className="flex justify-center items-center gap-2 pt-6">
          <button
            ...
            className="px-4 py-2 rounded-md text-sm font-medium bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 disabled:opacity-40 hover:bg-amber-100 dark:hover:bg-amber-950/50 transition-colors"
          >
            ← Trang trước
          </button>
